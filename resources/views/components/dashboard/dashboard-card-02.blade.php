<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
    <div class="px-5 pt-5">
        ...
        <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Number of Transactions</div>
        <div class="flex items-start">
            <div class="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">{{ \App\Models\Transaction::count() }}</div>
